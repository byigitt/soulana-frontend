  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
      <div className="group flex flex-col items-center p-8 rounded-2xl border bg-white/30 dark:bg-black/30 border-red-200 dark:border-red-900 transition-all duration-300 hover:scale-105">
        ...
        <p className="text-red-800/80 dark:text-rose-100/80">Toplam Bağış</p>
      </div>
      <div className="group flex flex-col items-center p-8 rounded-2xl border bg-white/30 dark:bg-black/30 border-red-200 dark:border-red-900 transition-all duration-300 hover:scale-105">
        ...
        <p className="text-red-800/80 dark:text-rose-100/80">Onaylı Kuruluş</p>
      </div>
      <div className="group flex flex-col items-center p-8 rounded-2xl border bg-white/30 dark:bg-black/30 border-red-200 dark:border-red-900 transition-all duration-300 hover:scale-105">
        ...
        <p className="text-red-800/80 dark:text-rose-100/80">İşlem Süresi</p>
      </div>
    </div>
  );
}; 
